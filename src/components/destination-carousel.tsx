        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-full border border-[#d7dbe4] bg-white px-4 py-3 text-xl"
          ...
          <div className="carousel-scrollbar-hide flex gap-5 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-3">
            {destinations.map((destination, index) => (
              <article
                ...
                className={`group relative h-[520px] min-w-[84%] snap-start overflow-hidden rounded-[22px] transition duration-500 md:min-w-[48%] xl:min-w-[32%] ${activeIndex === index ? "scale-[1] opacity-100" : "scale-[0.97] opacity-90"}`}
              >
                <Image
